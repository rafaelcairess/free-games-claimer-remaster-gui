...
> [!NOTE]
> **O Lontrium Control v1.0.0 já está disponível.** Baixe o instalador acima e confira-o usando o arquivo [`SHA256SUMS.txt`](https://github.com/rafaelcairess/lontrium/releases/latest/download/SHA256SUMS.txt).
